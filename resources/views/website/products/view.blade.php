            ...
            <div class="product_tab product_video fix">
                ...
                <div class="tab-content produc_tab_c">
                    <div class="tab-pane fade show active" id="p_tab1" role="tabpanel">
                        <div class="modal_img">
                            <a><img src="{{ asset('storage/app/public/images/'.$product->image) }}" alt=""></a>
                            <div class="img_icone">
                    ...
                    <ul class="nav" role="tablist">
                        <li>
                            <a class="active" data-toggle="tab" href="#p_tab1" role="tab" aria-controls="p_tab1"
                                aria-selected="false"><img src="assets\img\cart\cart.jpg" alt="">1</a>
                        </li>
                        <li>
                            <a data-toggle="tab" href="#p_tab2" role="tab" aria-controls="p_tab2"
                                aria-selected="false"><img src="assets\img\cart\cart2.jpg" alt="">2</a>
                        </li>
                        <li>
                            <a data-toggle="tab" href="#p_tab3" role="tab" aria-controls="p_tab3"
                                aria-selected="false"><img src="assets\img\cart\cart4.jpg" alt="">3</a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="col-lg-8 col-md-6">
            <div class="product_d_right">
                ...
                <div class="box_quantity mb-20">
                    ...
                    <a href="{{ route('add-to-cart', $product->id) }}" title="add to wishlist"><i class="fa fa-heart"
                ...
                <div class="wishlist-share">
                    ...
                    <ul>
                        ...
                        <li><a href="#"><i title="Tumblr" class="fa fa-tumblr"></i></a></li>
                        <li><a href="#"><i title="Pinterest" class="fa fa-pinterest"></i></a></li>
                        <li><a href="#"><i title="Linkedin" class="fa fa-linkedin"></i></a></li>
                    </ul>
                </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="block_title">
                <h3> 11 Sản Phẩm Cùng Thể Loại:</h3>
            </div>
        </div>
    </div>
    <div class="row">
